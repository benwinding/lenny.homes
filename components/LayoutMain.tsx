...
export function LayoutMain(props: { children?: any, color: {primary: string, secondary: string}  }) {
  return <BackGround config={{
    ...
    <div className="container p-3 pt-10 sm:p-6 mx-auto p-0 md:p-16 lg:px-auto z-10 relative">
      {props.children}
    </div>
  </BackGround>
}
...
function BackGround(props: { children: any, config: BackGroundConfig }) {
  ...
  return <div className="fixed inset-0 overflow-y-auto" style={{ backgroundColor: props.config.colorBgLeft }}>
    {props.children}
